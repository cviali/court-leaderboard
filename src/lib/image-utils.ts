...
export async function getCroppedImg(
  ...
  // Create intermediate canvas to hold the cropped data at full resolution
  ...
  // Create final output canvas with optimized dimensions (max 256x256)
  ...
  // As Base64 string with optimized quality (0.6 is a good balance for avatars)
